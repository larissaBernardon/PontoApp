...
namespace PontoApp.Controllers
{
    public class AnnouncementsController : Controller
    {
        ...
        public AnnouncementsController(Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Subtitle,createdAt")] Announcements announcements)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Subtitle,createdAt")] Announcements announcements)
        {
